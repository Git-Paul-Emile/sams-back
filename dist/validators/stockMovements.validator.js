...
export const createMouvementSchema = z
    ...
    .refine((data) => {
    const origins = [data.commandeId, data.achatId, data.prodOrderId, data.salesRequestId, data.materialRequestId].filter((v) => v != null);
...
//# sourceMappingURL=stockMovements.validator.js.map