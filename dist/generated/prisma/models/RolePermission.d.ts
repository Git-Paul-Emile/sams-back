...
export type RolePermissionWhereInput = {
    ...
    modules?: Prisma.StringNullableListFilter<"RolePermission">;
...
export type RolePermissionCreateInput = {
    role: $Enums.Role;
    modules?: Prisma.RolePermissionCreatemodulesInput | string[];
...
export type RolePermissionUpdateInput = {
    ...
    modules?: Prisma.RolePermissionUpdatemodulesInput | string[];
...
export type RolePermissionCreatemodulesInput = {
    set: string[];
};
export type RolePermissionUpdatemodulesInput = {
    set?: string[];
    push?: string | string[];
};
...
export type RolePermissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"role" | "modules" | "updatedAt", ExtArgs["result"]["rolePermission"]>;
...
export interface RolePermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const rolePermissionWithModulesOnly = await prisma.rolePermission.findMany({ select: { modules: true } })
     *
     */
     ...
     * })
     *
     * // Create many RolePermissions and only return the `modules`
     * const rolePermissionWithModulesOnly = await prisma.rolePermission.createManyAndReturn({
     *   select: { modules: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     *
     * // Update zero or more RolePermissions and only return the `modules`
     * const rolePermissionWithModulesOnly = await prisma.rolePermission.updateManyAndReturn({
     *   select: { modules: true },
     *   where: {
     *     // ... provide filter here
     *   },
...
export interface RolePermissionFieldRefs {
    ...
    readonly modules: Prisma.FieldRef<"RolePermission", 'String[]'>;
