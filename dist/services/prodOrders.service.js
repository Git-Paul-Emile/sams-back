...
export const prodOrdersService = {
    ...
    async create(input, ctx) {
        const created = await createWithSequenceNumber("OF", (likePrefix) => prodOrdersRepository.countByNumPrefix(likePrefix), (num) => prodOrdersRepository.create({
            num,
...
//# sourceMappingURL=prodOrders.service.js.map